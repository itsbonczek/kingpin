...
//! Project version number for kingpin-iOS.
FOUNDATION_EXPORT double kingpinVersionNumber;

//! Project version string for kingpin-iOS.
FOUNDATION_EXPORT const unsigned char kingpinVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <kingpin_iOS/PublicHeader.h>
